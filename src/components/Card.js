...
import { ReactComponent as HideAnswerIcon } from '../svgs/hideAnswer.svg';
import { ReactComponent as ShowAnswerIcon } from '../svgs/showAnswer.svg';
  ...
  return (
    ...
    >
      ...
      <StyledButton onClick={toggleSolution} variant="showHide">
        {solution ? <HideAnswerIcon /> : <ShowAnswerIcon />}
        <ScreenReaderOnly>
