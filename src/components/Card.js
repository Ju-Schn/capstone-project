...
export default function Card({
  ...
  const [isFlipped, toggleAnswer] = useState(true);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <StyledButton onClick={handleFlipClick} variant="showHide">
          <RotateIcon />
          <ScreenReaderOnly>
            {isFlipped ? 'Antwort verbergen' : 'Antwort anzeigen'}
          </ScreenReaderOnly>
        </StyledButton>
